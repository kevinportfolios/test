...
loggereth("start account balance: ".$totalAccountBalance);
...
try {
    ...
    if($isfirstorder==0){
        ...
        if($is_running_order==0){
            ...
            if($position==""){
                loggereth('order meet the stoplose');
                orderloggereth('order meet the stoplose:'.date('Y-m-d H:i:s',$time));
                ...
                //     $position = "short to long";
                // }
                // loggereth('position:'.$position.';action:'.$action);
            ...
            if($finalema10>$finalema20){
                //做多
                loggereth('position:'.$position);
            
                if($position =="short to long"){
                    $buyingprice=$closePrice20[0];
                    //if not,open order
                     //做多
                     loggereth('order 做多:'.date('Y-m-d H:i:s',$time));
                
                    //  $stopLoss=$currentprice-50;
                    $stopLoss=$finalema20-10;
                     ...
                     try {
                        ...
                        orderloggereth('making order 做多:'.date('Y-m-d H:i:s',$time));
                ...
                loggereth('running order 做多:'.date('Y-m-d H:i:s',$time));
            ...
            // }else if(($finalema10+10)<$finalema20){
                ...
                if($position =="long to short"){
                    //if not,open order
                    //做空
                    loggereth('order 做空:'.date('Y-m-d H:i:s',$time));
                    ...
                    try {
                        ...
                        orderloggereth('making order 做空:'.date('Y-m-d H:i:s',$time));
                ...
                loggereth('running order 做空:'.date('Y-m-d H:i:s',$time));
            ...
            if($action=="long"){
                //close 做多
                    ...
                    if($beforeearninglvl!=0){
                        ...
                        if($canclose>1){
                            loggereth('diffprice>200 long:'.date('Y-m-d H:i:s',$time).';buyingprice:'.$buyingprice.';currentprice:'.$currentprice);
                    ...
                    if(($finalema10<$finalema20) || $allowtoclose==1 || ($currentprice<($finalema20-5))){
                        loggereth('close 做多:'.date('Y-m-d H:i:s',$time));
                        ...
                        try {
                            ...
                            orderloggereth('closing order 做多:'.date('Y-m-d H:i:s',$time));
                        }catch (\Exception $e){
                ...
                loggereth('running cancel 做多:'.date('Y-m-d H:i:s',$time));
               ...
               //close 做空
                    ...
                    if($beforeearninglvl!=0){
                        ...
                        if($canclose>1){
                            loggereth('diffprice>200 short:'.date('Y-m-d H:i:s',$time).';buyingprice:'.$buyingprice.';currentprice:'. $currentprice);
                    ...
                    // if(($diffema<0.1)||$allowtoclose==1){
                    if(($finalema10>$finalema20) || $allowtoclose==1 || ($currentprice>($finalema20+5))){
                        loggereth('close 做空:'.date('Y-m-d H:i:s',$time));
                        ...
                        try {
                            ...
                            orderloggereth('closing order 做空:'.date('Y-m-d H:i:s',$time));
                        }catch (\Exception $e){
                ...
                loggereth('running cancel 做空:'.date('Y-m-d H:i:s',$time));
            }
...
if($curentAccountBalance<($totalAccountBalance*0.8)){
    if($action=="long"){
        ...
        loggereth('total loss more than 20%, close 做多:'.date('Y-m-d H:i:s',$time));
        ...
        loggereth('total loss more than 20%, close 做空:'.date('Y-m-d H:i:s',$time));
