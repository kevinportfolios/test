...
class RequestV5Cancel
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->host=$data['host'] ?? 'https://api2-2.bybit.com/contract';
    ...
    protected function send(){
        ...
        if($this->type=='GET') $url.= '?_sp_category=fbu&_sp_business=usdt&_sp_response_format=portugal'.http_build_query($this->data);
